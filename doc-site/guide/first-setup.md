...
本页按实际使用顺序完成工作区、模型和能力配置。配置完成后，你可以在指定目录内发起第一条任务，并通过预览和审阅确认结果。
...
1. 点击打开 / 选择文件夹。
2. 在系统对话框里选一个本地目录，并允许浏览器访问。

![欢迎页：打开本地工作区](/images/open-workspace.png)

<Callout>
从这一步起，这个目录就是 Agent 能读写的范围。会话配置会落在目录里的 <code>.cottage/</code>，方便你连同工作一起备份。
</Callout>
