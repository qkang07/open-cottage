...
| `architecture/` | **开发者**：架构、写能力包、部署 Service / llm-proxy、贡献 |

伴随服务由 Go 实现；日常用户可从官方 Demo 与使用指南开始，高级用法可通过开源代码自行部署，本地启动与服务部署归入开发者文档。官方 Demo 与开源仓库链接统一维护在 `.vitepress/site-links.mjs`。
